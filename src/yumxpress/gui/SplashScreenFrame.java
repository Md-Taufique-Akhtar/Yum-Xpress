...
public class SplashScreenFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Developed by Taufique");

        jPanel2.setBackground(new java.awt.Color(204, 204, 204));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel4.setText("Splash Screen Frame");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(80, 80, 80)
                        .addComponent(jProgressBar1, javax.swing.GroupLayout.PREFERRED_SIZE, 936, javax.swing.GroupLayout.PREFERRED_SIZE)))
...
class SplashThread extends Thread{
 ...
 while(jProgressBar1.getValue()<jProgressBar1.getMaximum()){
   ...
   UserVerifyFrame verify=new UserVerifyFrame();
